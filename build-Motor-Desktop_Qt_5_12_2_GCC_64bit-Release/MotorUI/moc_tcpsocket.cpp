...
#include "../../MOTOR/MotorUI/tcpsocket.h"
...
QT_MOC_LITERAL(5, 29, 8) // "recvData"

    },
    "TcpSocket\0dataReady\0\0ip\0data\0recvData"
};
...
// SIGNAL 0
void TcpSocket::dataReady(const QString & _t1, const QByteArray & _t2)
{
